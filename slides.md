...
일본 취업을 준비하며 정보 부족으로 고생한 경험에서 출발했습니다.

**나루**는 한국인을 위한 **일본 취업 올인원 플랫폼**입니다.

| 기능 | 내용 |
|------|------|
| 🔍 채용 공고 | 직무·연봉·근무지 필터 탐색 |
| 🏢 기업 정보 | 복리후생·평가·규모 사전 리서치 |
| 🎪 이벤트 | 설명회·세미나·밋업 통합 캘린더 |
| 🤝 멘토링 | 일본 현직자와 1:1 취업 상담 |

> 오늘 웨비나에서 나온 전략들을 **실제로 실행할 수 있는 도구**가 나루입니다.
---
